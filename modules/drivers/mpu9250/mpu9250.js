...
// mpu6050.js をベースにmpu9250.js を目指したい
...
const REGISTERS = {
    ...
    PWR_MGMT_1: 0x6B,
    PWR_MGMT_2: 0x6C,
    WHO_AM_I: 0x75 // Register 117 - Who Am I
};
Object.freeze(REGISTERS);

const EXPECTED_WHO_AM_I = 0x68; // MPU6050では 0x68
const EXPECTED_WHO_AM_I_6500 = 0x70;
const EXPECTED_WHO_AM_I_9250 = 0x71; // GO 113
...
class Gyro_Accelerometer extends SMBus {
    ...
    checkIdentification() {
        ...
        if (gxlID != EXPECTED_WHO_AM_I_9250) throw (`bad WHO_AM_I ID ${gxlID} for go.`);
    }
